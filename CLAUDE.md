...
- Les pages officielles de l'API la réservent « à des usages non lucratifs » et interdisent « la facturation de l'accès pour des tiers comme des candidats ». Aucune facturation liée aux offres ou à l'envoi ne doit être construite sans l'accord écrit du support (question bloquante A1 dans `docs/QUESTIONS.md`).
