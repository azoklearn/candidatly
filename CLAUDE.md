...
- 2026-09-13 : CV et lettre facultatifs dans le questionnaire (C89) : « Passer cette étape » mémorisé dans `profiles.documents_skipped_at` ; sans lettre de base, la fiche d'offre renvoie vers le compte pour l'ajouter.
- 2026-09-12 : aperçu flouté des offres sur `/forfait` avant paiement (C88) : seules la ville, le contrat, la fraîcheur et le score sont envoyés au navigateur, les barres floutées sont vides.
- 2026-09-12 : prix baissés à 9,99 / 14,99 / 19,99 € par mois (99,90 / 149,90 / 199,90 € par an), affichage mensuel par défaut. Le paiement vérifie que le plan Whop relié porte bien le prix affiché avant d'ouvrir la page de paiement.
