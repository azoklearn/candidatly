/**
 * NAF rev. 2 labels (732 sub-classes), absent from the company API (docs/API_RECHERCHE_ENTREPRISES.md
 * section 8). Generated from docs/reference/naf-rev2-codes-labels.json; do not edit by hand.
 */
